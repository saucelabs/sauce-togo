...
public class Main {
  public static void main(String[] args) {
    ...
    // Check that SOCAT is running as well
    Path jarPath = Paths.get("sauce-grid/target/sauce-grid-0.1-SNAPSHOT.jar").toAbsolutePath();
    ...
    Path debugToml =
      Paths.get("sauce-grid/src/test/resources/sauce_togo_config_debugging.toml")
        .toAbsolutePath();
    org.openqa.selenium.grid.Bootstrap.main(
      new String[]{
        "--ext",
        jarPath.toString(),
        "standalone",
